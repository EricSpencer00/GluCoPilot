          ...
          <Card.Content>
            ...
            {isLoading ? (
              ...
              recommendations.map((rec: any, idx: number) => (
                <Surface key={idx} style={{ marginVertical: 8, borderRadius: 16, elevation: 6, backgroundColor: '#fff', shadowColor: '#00796B', shadowOpacity: 0.15, shadowRadius: 14, shadowOffset: { width: 0, height: 6 } }}>
